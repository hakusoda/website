<!-- https://icons.getbootstrap.com/icons/clipboard-plus-fill -->
<script lang="ts">
	export let size = 16;
</script>

<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" class="bi bi-clipboard-plus-fill" viewBox="0 0 16 16">
