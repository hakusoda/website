...
import { isUUID, hasBit } from '../shared/util';
import { TeamRolePermission } from '../shared/enums';
import type { DatabaseTeam, UserNotification, TeamActionLogType, MellowActionLogItemType } from '../shared/types';
...
export async function createTeamAuditLog(type: TeamActionLogType, author_id: string, team_id: string, data?: any) {
