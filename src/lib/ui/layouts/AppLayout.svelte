<script lang="ts">
	...
	import { UserNotificationState } from '$lib/shared/enums';
	import { get_user_notification_uri } from '$lib/shared/util';
	import { markNotificationAsRead, clearAllNotifications, markAllNotificationsAsRead } from '$lib/client/api';
						...
						{#if notifications.length}
							<div class="notifications-container">
								{#each notifications as item}
									<a href={get_user_notification_uri(item)} class="notification" on:click={() => {
