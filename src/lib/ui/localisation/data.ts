export default {
	'en-AU': {
		...
		'mellow_link_editor.requirements.platforms.1': 'Patreon',
		...
		'mellow_sync_action.requirement.12': 'Must be subscribed to a campaign tier',
		'mellow_sync_action.requirement.12.campaign_id': 'Campaign ID',
		'mellow_sync_action.requirement.12.tier_id': 'Tier ID',
