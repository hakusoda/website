export default {
	'en-AU': {
		...
		'mellow_bind.requirement.0': 'Must have a user connection',
		'mellow_bind.requirement.1': 'Must have a Group Role',
		'mellow_bind.requirement.1.select': 'Group Roles',
		...
		'mellow_bind.explanation.0': 'Assigns {0.items.length} Discord Role{0.items.length|s} to members',
