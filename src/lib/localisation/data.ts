export default {
	'en-AU': {
		...
		'mellow.server.settings.roblox.binds': 'Server Profile Actions',
		'mellow.server.settings.roblox.binds.create': 'Create New Action',
		'mellow.server.settings.roblox.binds.import': 'Import Actions',
		...
		'mellow_link_editor.type': 'Action',
		...
		'mellow_link_editor.requirements': 'User Requirements',
		...
		'mellow_bind.explanation.0': 'Gives {0.length} Discord Role{0.length|s}',
		'mellow_bind.explanation.1': 'Bans users from the Discord Server',
		'mellow_bind.explanation.2': 'Kicks users from the Discord Server',
