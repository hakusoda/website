export default {
	'en-AU': {
		...
		'mellow_server_audit_log.type.4.requirements': 'Requirements Updated',
		'mellow_server_audit_log.type.4.requirements_type': 'Requirements Type Updated',
		...
		'mellow_sync_action.requirement.0': 'Must have a user connection',
